...
def get_predictions(model):
    ...
    cfm_plot.figure.savefig('/u/home/ank/3D-Castellvi-Prediction/sources/plots/confusion_matrix.png')
...
def main(params):
    ckpt_path = '/u/home/ank/3D-Castellvi-Prediction/experiments/baseline_models/best_models/densenet-epoch=199-val_loss=1.85.ckpt'
